...
func (c *BFFAdminClientImpl) GetDubboStub(cc *triple.TripleConn) BFFAdminClient {
	return NewBFFAdminClient(cc)
}

func (c *BFFAdminClientImpl) XXX_InterfaceName() string {
	return "yrcs.nicehouse.api.bffadmin.v1.BFFAdmin"
}

func NewBFFAdminClient(cc *triple.TripleConn) BFFAdminClient {
	return &bFFAdminClient{cc}
}

func (c *bFFAdminClient) ListRoles(ctx context.Context, in *common.PagingRequest, opts ...grpc_go.CallOption) (*common.PagingResponse, common1.ErrorWithAttachment) {
	out := new(common.PagingResponse)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/ListRoles", in, out)
}

func (c *bFFAdminClient) GetRole(ctx context.Context, in *GetRoleRequest, opts ...grpc_go.CallOption) (*Role, common1.ErrorWithAttachment) {
	out := new(Role)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/GetRole", in, out)
}

func (c *bFFAdminClient) CreateRole(ctx context.Context, in *CreateRoleRequest, opts ...grpc_go.CallOption) (*common.CommonCreate, common1.ErrorWithAttachment) {
	out := new(common.CommonCreate)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/CreateRole", in, out)
}

func (c *bFFAdminClient) UpdateRole(ctx context.Context, in *UpdateRoleRequest, opts ...grpc_go.CallOption) (*common.CommonUpdate, common1.ErrorWithAttachment) {
	out := new(common.CommonUpdate)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/UpdateRole", in, out)
}

func (c *bFFAdminClient) DeleteRoles(ctx context.Context, in *common.CommonDeletesRequest, opts ...grpc_go.CallOption) (*emptypb.Empty, common1.ErrorWithAttachment) {
	out := new(emptypb.Empty)
	interfaceKey := ctx.Value(constant.InterfaceKey).(string)
	return out, c.cc.Invoke(ctx, "/"+interfaceKey+"/DeleteRoles", in, out)
}

// BFFAdminServer is the server API for BFFAdmin service.
// All implementations must embed UnimplementedBFFAdminServer
...
type BFFAdminServer interface {
	...
	mustEmbedUnimplementedBFFAdminServer()
}
...
func (s *UnimplementedBFFAdminServer) XXX_ServiceDesc() *grpc_go.ServiceDesc {
	return &BFFAdmin_ServiceDesc
}
func (s *UnimplementedBFFAdminServer) XXX_InterfaceName() string {
	return "yrcs.nicehouse.api.bffadmin.v1.BFFAdmin"
}

func (UnimplementedBFFAdminServer) mustEmbedUnimplementedBFFAdminServer() {}

// UnsafeBFFAdminServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to BFFAdminServer will
...
func RegisterBFFAdminServer(s grpc_go.ServiceRegistrar, srv BFFAdminServer) {
	s.RegisterService(&BFFAdmin_ServiceDesc, srv)
}

func _BFFAdmin_ListRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
...
func _BFFAdmin_GetRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
...
func _BFFAdmin_CreateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
...
func _BFFAdmin_UpdateRole_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
...
func _BFFAdmin_DeleteRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc_go.UnaryServerInterceptor) (interface{}, error) {
...
// BFFAdmin_ServiceDesc is the grpc_go.ServiceDesc for BFFAdmin service.
